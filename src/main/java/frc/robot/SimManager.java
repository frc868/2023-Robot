    ...
    public static void configureNTCommands(Drivetrain drivetrain,
        ...
        if (Constants.IS_NT_COMMANDS_ENABLED) {
            ...
            LoggingManager.getInstance().addGroup(new LogGroup(
                    ...
                    new SendableLogger("Elbow/Commands", "Disable", Commands
                            .runOnce(elbow::disable)),
                    ...
                    new SendableLogger("Drivetrain/Commands", "Turn 0°",
                            drivetrain.turnWhileMovingCommand(0, true)),
                    new SendableLogger("Drivetrain/Commands", "Turn 90°",
                            drivetrain.turnWhileMovingCommand(Math.PI / 2, true)),
                    new SendableLogger("Drivetrain/Commands", "Turn 180°",
                            drivetrain.turnWhileMovingCommand(Math.PI, true)),
                    new SendableLogger("Drivetrain/Commands", "Turn 270°",
                            drivetrain.turnWhileMovingCommand(3 * Math.PI / 2, true)),
