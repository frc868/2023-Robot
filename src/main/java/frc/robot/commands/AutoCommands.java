...
// public static Command driveOut(
// PathPlannerTrajectory driveToGamePiece,
// Drivetrain drivetrain, Intake intake, Manipulator manipulator, Elevator
// elevator, Elbow elbow) {
...
// elbow))),
// IntakingCommands.finishIntakingCommand(gamePieceSupplier, intake,
// manipulator,
// elevator,
// elbow));
...
// public static Command driveAndScore(double waitTimeForElevator,
...
// public static Command scorePreload(Supplier<GamePieceLocation>
// gamePieceLocationSupplier,
// Drivetrain drivetrain, Intake intake, Manipulator manipulator, Elevator
// elevator, Elbow elbow) {
// return Commands.sequence(
// ScoringCommands.raiseElevatorCommand(
...
// public static Command launchCube(Intake intake) {
// return Commands.sequence(
