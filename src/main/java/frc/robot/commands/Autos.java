...
// case CUBE:
// waypoints.add(new
// PathPoint(FieldConstants.Blue.AutoPathPoints.North.MOBILITY,
...
// FieldConstants.Blue.AutoPathPoints.North.CHARGE_STATION_BALANCE,
// Rotation2d.fromDegrees(0),
// Rotation2d.fromDegrees(settings.get(0).getValue() ==
// AutoSettingValue.CUBAPULT ? 0 : 180))
// .withPrevControlLength(3));
// }
// }
// return waypoints;
...
// Function<AutoPath, Command> command = (autoPath) -> Commands.sequence(
// Commands.either(
...
// AutoCommands.driveOut(autoPath.getTrajectories().get(0), drivetrain, intake,
// manipulator, elevator,
// elbow));
// return new AutoRoutine("North: 1 Piece", settings, autoPathSupplier,
// blueInitialPoseSupplier, command);
// }
...
// case CUBE:
// waypoints.add(new
// PathPoint(FieldConstants.Blue.AutoPathPoints.South.MOBILITY,
// Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(180)));
// break; // flip 180 if not using cubapult
// default:
// throw new IllegalArgumentException("Unexpected setting value!");
...
// manipulator, elevator,
// elbow));
// return new AutoRoutine("South: 1 Piece", settings, autoPathSupplier,
// blueInitialPoseSupplier, command);
// }
// }
