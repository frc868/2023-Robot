...
public class balanceRobot extends CommandBase{
    ...
    /**
     * attempts to move the robot against the force of gravity based on its pitch (and roll just in case)
     */
    @Override
    public void execute(){
        double xSpeed=-1*Math.sin(pigeon.getPitch())*0.1; // some constant for gravity and friction and whatever (untested)
