...
public class LogProfileBuilder {
    ...
    public static LogItem<?>[] buildCANSparkMaxLogItems(CANSparkMax obj) {
        return new LogItem<?>[] {
                new LogItem<Double>(LogType.NUMBER, "Encoder Distance", obj.getEncoder()::getPosition, LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Encoder Distance Conversion Factor",
                        obj.getEncoder()::getPositionConversionFactor, LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Encoder Speed", obj.getEncoder()::getVelocity, LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Encoder Speed Conversion Factor",
                        obj.getEncoder()::getVelocityConversionFactor, LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Closed Loop Ramp Rate", obj::getClosedLoopRampRate, LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Open Loop Ramp Rate", obj::getOpenLoopRampRate, LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Speed", obj::get, LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Bus Voltage", obj::getBusVoltage, LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Motor Temperature", obj::getMotorTemperature, LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Output Current", obj::getOutputCurrent, LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Device ID", () -> (double) obj.getDeviceId(), LogLevel.INFO),
                new LogItem<String>(LogType.STRING, "Firmware Version", obj::getFirmwareString, LogLevel.INFO),
                new LogItem<Boolean>(LogType.BOOLEAN, "Is In Brake Mode",
                        () -> obj.getIdleMode() == CANSparkMax.IdleMode.kBrake, LogLevel.INFO),
                new LogItem<Boolean>(LogType.BOOLEAN, "Is Inverted", obj::getInverted, LogLevel.INFO),
                new LogItem<Boolean>(LogType.BOOLEAN, "Is Follower", obj::isFollower, LogLevel.INFO),
                new LogItem<Boolean>(LogType.BOOLEAN, "Faults/Brownout",
                        () -> obj.getFault(CANSparkMax.FaultID.kBrownout), LogLevel.INFO),
                ...
                new LogItem<Boolean>(LogType.BOOLEAN, "Sticky Faults/DRV Fault",
                        () -> obj.getStickyFault(CANSparkMax.FaultID.kStall), LogLevel.INFO),
                new LogItem<Double>(LogType.NUMBER, "Timer", Timer::getFPGATimestamp, LogLevel.INFO)
        };
    }
